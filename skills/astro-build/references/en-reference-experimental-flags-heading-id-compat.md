<!-- Source: https://docs.astro.build/en/reference/experimental-flags/heading-id-compat/ -->
...
[Edit page](https://github.com/withastro/docs/edit/main/src/content/docs/en/reference/experimental-flags/heading-id-compat.mdx)
