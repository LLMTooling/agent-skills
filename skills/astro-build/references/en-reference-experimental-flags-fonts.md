...
2. Apply styles using the `<Font />` component. It must be imported and added to your page `<head>`. Providing the font’s [`cssVariable`](#cssvariable) is required, and you can optionally [output preload links](#preload):
   ...
   * [CSS](#tab-panel-3117)
   * [Tailwind CSS 4.0](#tab-panel-3118)
   * [Tailwind CSS 3.0](#tab-panel-3119)
...
* [Adobe](#tab-panel-3123)
* [Bunny](#tab-panel-3124)
* [Fontshare](#tab-panel-3125)
* [Fontsource](#tab-panel-3126)
* [Google](#tab-panel-3127)
* [Google Icons](#tab-panel-3128)
...
* [Relative path](#tab-panel-3120)
* [URL](#tab-panel-3121)
* [Package import](#tab-panel-3122)
...
[Edit page](https://github.com/withastro/docs/edit/main/src/content/docs/en/reference/experimental-flags/fonts.mdx)
