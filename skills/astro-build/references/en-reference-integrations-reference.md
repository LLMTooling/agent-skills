...
[Section titled “Page build data”](#page-build-data)
...
[Section titled “moduleSpecifier”](#modulespecifier)
...
[Section titled “Serialized SSR manifest properties”](#serialized-ssr-manifest-properties)
...
[Section titled “componentMetadata”](#componentmetadata)
...
[Section titled “inlinedScripts”](#inlinedscripts)
...
[Section titled “clientDirectives”](#clientdirectives)
...
[Section titled “serverIslandNameMap”](#serverislandnamemap)
...
[Section titled “clientEntrypoint”](#cliententrypoint)
...
[Section titled “entrypoint”](#entrypoint-1)
...
[Section titled “entrypoint”](#entrypoint-2)
...
[Section titled “component”](#component-1)
...
[Section titled “fallbackRoutes”](#fallbackroutes)
...
[Section titled “isIndex”](#isindex)
...
[Section titled “dynamic”](#dynamic)
...
[Section titled “containsHead”](#containshead)
...
[Section titled “renderToStaticMarkup()”](#rendertostaticmarkup)
...
[Section titled “supportsAstroStaticSlot”](#supportsastrostaticslot)
...
[Section titled “renderHydrationScript()”](#renderhydrationscript)
...
[Section titled “hrefRoot”](#hrefroot)
...
[Section titled “routes”](#routes-1)
...
[Section titled “routeData”](#routedata-1)
...
[Section titled “styles”](#styles-1)
...
[Section titled “userAssetsBase”](#userassetsbase)
...
[Section titled “buildFormat”](#buildformat)
...
[Section titled “assetsPrefix”](#assetsprefix)
...
[Section titled “clientDirectives”](#clientdirectives-1)
...
[Section titled “entryModules”](#entrymodules)
...
[Section titled “inlinedScripts”](#inlinedscripts-1)
...
[Section titled “assets”](#assets-1)
...
[Section titled “componentMetadata”](#componentmetadata-1)
...
[Section titled “pageModule”](#pagemodule)
...
[Section titled “renderers”](#renderers-1)
...
[Section titled “pageMap”](#pagemap)
...
[Section titled “serverIslandMap”](#serverislandmap)
...
[Section titled “serverIslandNameMap”](#serverislandnamemap-1)
...
[Section titled “locales”](#locales)
...
[Section titled “fallbackType”](#fallbacktype)
...
[Section titled “domainLookupTable”](#domainlookuptable)
...
[Section titled “checkOrigin”](#checkorigin)
...
[Section titled “allowedDomains”](#alloweddomains)
...
[Section titled “sessionConfig”](#sessionconfig)
...
[Section titled “buildClientDir”](#buildclientdir)
...
[Section titled “buildServerDir”](#buildserverdir)
...
[Section titled “SSRManifestCSP”](#ssrmanifestcsp)
...
[Section titled “cspDestination”](#cspdestination)
...
[Section titled “scriptHashes”](#scripthashes)
...
[Section titled “scriptResources”](#scriptresources)
...
[Section titled “isStrictDynamic”](#isstrictdynamic)
...
[Section titled “styleHashes”](#stylehashes)
...
[Section titled “styleResources”](#styleresources)
...
[Section titled “redirectRoute”](#redirectroute-2)
...
[Edit page](https://github.com/withastro/docs/edit/main/src/content/docs/en/reference/integrations-reference.mdx)
[Translate this page](https://contribute.docs.astro.build/guides/i18n/)

[Previous

astro/zod](/en/reference/modules/astro-zod/)
[Next
